...
var _search = require('./classes/search.js');

var _search2 = _interopRequireDefault(_search);

var _image = require('./classes/image.js');
...
(0, _jquery2.default)(function () {
  ...
  (0, _jquery2.default)("[bubble-on-focus]").not("focused").focus(function () {
    var $target = (0, _jquery2.default)(this).closest((0, _jquery2.default)(this).attr("bubble-on-focus"));
  ...
  var toggleSocialPrompt = function toggleSocialPrompt() {
    return (0, _jquery2.default)(".social-prompt").toggleClass("active");
  };
...
var Search = function () {
  ...
  (0, _createClass3.default)(Search, [{
    key: 'build_autocomplete',
    value: function build_autocomplete(data) {
      var options = {
        list: data,
        autofirst: true,
