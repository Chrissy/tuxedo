...
(function() {
  window.Image = (function() {
    ...
    Image.prototype.filepicker_url = function() {
      ...
      compression = this.image.attr("data-dont-compress") ? "100" : "60";
      return "https://www.filepicker.io/api/file/" + url + "/convert?fit=crop&format=jpg&quality=" + compression + "&h=" + (this.dimension("h").increment()) + "&w=" + (this.dimension("w").increment()) + "&cache=true";
    };

    Image.prototype.upscale = function() {
      var img, self;
      self = this;
      return img = self.image.clone().attr("src", this.filepicker_url()).load(function() {
...
(function() {
  $(function() {
    ...
    $(".show-extra-options").on("click", function() {
      return $(this).siblings(".extra-options").toggle();
    });
