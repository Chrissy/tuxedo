...
(function() {
  window.Image = (function() {
    ...
    Image.prototype.filepicker_url = function() {
      ...
      return "https://www.filepicker.io/api/file/" + url + "/convert?fit=crop&format=jpg&quality=60&h=" + (this.dimension("h").increment()) + "&w=" + (this.dimension("w").increment()) + "&cache=true";
    };
